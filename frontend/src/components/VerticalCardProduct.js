...

                {
                    loading ? (
                        loadingList.map((product, index) => {
                            return (
                                <div className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-96 bg-white rounded-lg shadow-sm flex flex-col border border-gray-100 animate-pulse' key={index}>
                                    <div className='bg-gray-100 h-48 p-4 min-w-[280px] md:min-w-[145px] rounded-t-lg'></div>
                        ...
                        data.map((product, index) => {
                            return (
                                <Link to={"product/" + product?._id} className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-xl shadow-soft hover:shadow-hover transition-all flex flex-col border border-transparent hover:border-gray-100 group overflow-hidden relative' key={product?._id}>
